...
namespace Day21_PracticeProblem
{
    ...
    {
        public static SqlConnection con = new SqlConnection(@"data source=DESKTOP-SAGJTNV\SQLEXPRESS;initial catalog=Services;integrated security=true");
        ...
        public static void Update()
        {
            ...
            {
                con.Open();
                string query = "Update Customer Set Salary = 70000 Where Customer_Name='Madhur Verma'";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.ExecuteNonQuery();
